...
@section('title', 'Edit Data Admin Keuangan')
    ...
    <div class="col-lg-7">
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
                <h3 class="">Edit Data Admin Keuangan</h3>
            </div>
            ...
            <div class="card-body p-2 m-2">
                <div class="row">
                    <div class="container">
                        ...
                        <form method="post" action="{{ route('adminkeuangan.update',['adminkeuangan'=>$adminkeuangan->id]) }}">
                            @method('put')
                            @csrf
                            <div class="form-group mt-3">
                                <label for="nama">Nama Admin Keuangan</label>
                                <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" id="nama" value="{{ $adminkeuangan->nama }}">
