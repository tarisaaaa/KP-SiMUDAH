...
@section('title', 'Tambah Data Admin Aplikasi')
    ...
    <div class="col-lg-7">
        <div class="card shadow m-4">
            ...
            <div class="card-header py-3">
                <h3 class="mt-2">Tambah Data Admin Aplikasi</h3>
            </div>
                ...
                <div class="row">
                    <div class="container">
                        ...
                        <form method="post" action="{{ route('adminaplikasi.store') }}">
                            ...
                            <a href="{{ route('adminaplikasi.index') }}" class="btn btn-outline-secondary btn-block">Batal</a>
                        </form>
